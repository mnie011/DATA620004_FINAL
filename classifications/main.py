...
def main():
    ...
    if args.model_name == 'ViT':
        net = ViT(image_size=32, patch_size=4, num_classes=100, dim=256, depth=6, heads=8, mlp_dim=1024, dropout=0.1,
                  emb_dropout=0.1)
    ...
    if args.resume:
        ...
        checkpoint = torch.load('../muse/checkpoints/{}_{}.pth'.format(args.model_name, args.version))
